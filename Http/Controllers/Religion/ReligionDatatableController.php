...
class ReligionDatatableController extends Controller
{
    public function datatable()
    {
        ...
        return DataTables::of($religion)
            ...
            ->editColumn('action', function ($religion) {
                $edit  = '<a href="' . route('religion.edit', $religion->id) . '"
                                class="btn btn-xs btn-info">
                                <i class="fa fa-edit" aria-hidden="true"></i>
                            </a>';
                $delete = '<a data-href="' . route('religion.destroy', $religion->id) . '" data-toggle="modal" data-target="#confirm-delete-modal"
