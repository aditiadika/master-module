...
namespace Modules\Master\Http\Controllers\Golongan;
...
class GolonganDatatableController extends Controller
{
    public function datatable()
    {
        $religion = Golongan::orderBy('name', 'ASC')->get();
        ...
        return DataTables::of($religion)
            ...
            ->editColumn('action', function ($religion) {
                $edit  = '<a href="' . route('golongan.edit', $religion->id) . '"
                                class="btn btn-xs btn-info">
                                <i class="fa fa-edit" aria-hidden="true"></i>
                            </a>';
                $delete = '<a data-href="' . route('golongan.destroy', $religion->id) . '" data-toggle="modal" data-target="#confirm-delete-modal"
