...
<div class="container pd-x-0 pd-lg-x-10 pd-xl-x-0">
    <div class="d-sm-flex align-items-center justify-content-between mg-b-20 mg-lg-b-25 mg-xl-b-30">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb breadcrumb-style1 mg-b-10">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">
                        <a href="{{ route('marital-status.index') }}">Marital Status</a>
                    </li>
                    <li class="breadcrumb-item active" aria-current="page">
                        <a href="#">edit</a>
                    </li>
        ...
        <div class="text-right">
            <a href="{{ route('marital-status.index') }}" title="Back">
                ...
                <div class="col-md-12">
                    <div class="portlet box green">
                        ...
                        <div class="portlet-body">
                            ...
                            <form action="{{ route('marital-status.update', $editData->id) }}" method="POST">
                                @csrf
                                @method('PATCH')
                                ...
                                <div class="form-group{{ $errors->has('is_active') ? ' has-error' : '' }}">
                                    ...
                                    <select name="is_active" class="form-control">
                                        <option value="1" {{ $editData->is_active == true ? 'selected': '' }}>Active
                                        </option>
                                        <option value="0" {{ $editData->is_active == false ? 'selected': '' }}>Inactive
                                        </option>
                                    </select>
