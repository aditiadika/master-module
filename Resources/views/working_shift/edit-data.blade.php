    ...
    <div class="container pd-x-0 pd-lg-x-10 pd-xl-x-0">
        <div class="d-sm-flex align-items-center justify-content-between mg-b-20 mg-lg-b-25 mg-xl-b-30">
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb breadcrumb-style1 mg-b-10">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">
                            <a href="{{ route('working-shift.index') }}">Working Shift</a>
                        </li>
                        <li class="breadcrumb-item active" aria-current="page">
                            <a href="#">edit</a>
                        </li>
            ...
            <div class="text-right">
                <a href="{{ route('working-shift.index') }}" title="Back">
                    ...
                    <div class="col-md-12">
                        <div class="portlet box green">
                            <div class="portlet-title">
                                <h4>Edit Working Shift</h4>
                            </div>
                            <div class="portlet-body">
                                @include('flash::message')
                                <form action="{{ route('working-shift.update', $editData->id) }}" method="POST">
                                    @csrf
                                    @method('PATCH')
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" value="{{ $editData->start_time }}" class="form-control clockpicker" name="start_time">
                                        </div>
                                        <div class="form-group col-md-6">
                                            <label for="inputPassword4">End Time</label>
                                            <input type="text" class="form-control clockpicker" value="{{ $editData->end_time }}" name="end_time">
                                        </div>
                                    </div>
